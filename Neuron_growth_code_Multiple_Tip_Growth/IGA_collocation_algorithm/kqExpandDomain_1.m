function [phi_out,theta_out,conc_out,tempr_out,phi_initial_out,theta_initial_out,conc_initial_out,tempr_initial_out,bcid,A_out,H_out,Hstate_out] = ...
    kqExpandDomain_1(sz,phi,theta,conc,tempr,oldNuNv,newNuNv,A,H,Hstate)
...
% for i = 1:outSz
%     for j = 1:floor(outSz/2)
%         theta_out(j,i) = rand*6-3;
%     end
% end
...
% 
% actin_i_off = floor(outSz/2-M_actin/2);
% actin_j_off = floor(outSz/2-M_actin/2);
...
% for i = 3:M-2
%     for j = 3:M-2
%         A_out(i+actin_i_off, j+actin_j_off) = A(i,j);
%     end
% end
% for i = 3:M-2
%     for j = 3:M-2
%         H_out(i+actin_i_off, j+actin_j_off) = H(i,j);
%     end
% end
% for i = 3:M-2
%     for j = 3:M-2
%         Hstate_out(i+actin_i_off, j+actin_j_off) = Hstate(i,j);
%     end
% end
