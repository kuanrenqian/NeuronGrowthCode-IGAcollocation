function [ M_arr , point_list , span_list ] = makeIndexColBspline( knot, p, deriv_order )
...
%     if (i>1) && (i<len)
%         point_list(i) = sum(knot(i+1:i+p))./p;   
%         span_list(i) = FindSpan_modified(nobu,p,point_list(i),knot);
%     end
% end
% 
% M_arr  = evalBspline(point_list, span_list, knot, p, deriv_order);
