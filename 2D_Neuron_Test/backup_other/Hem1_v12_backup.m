...
for t = 1:param.T
    ...
    % 3) call ODE solver
    [tt,Y] = ode45(@evolvesystem_local,T,Y_0,[],param);
...
%% Functions
function dydt = evolvesystem_local(~,y,param)
% 0) unpack y = [A..H..]
L = length(y)/2;
...
param.A = param.A+param.A_0;
param.H = param.H+param.H_0;
end