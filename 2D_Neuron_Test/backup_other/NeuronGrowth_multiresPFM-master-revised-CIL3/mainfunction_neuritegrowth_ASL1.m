...
parameters = setparameters_neurite_ASL1();
...
%save('theta_original_ASL1_2.mat','theta_original');

theta1 = load('theta_original_ASL1_2.mat');
theta = theta1.theta_original;

figure
imagesc(phi)

MultipleResolution2D_neurite_ASL1
