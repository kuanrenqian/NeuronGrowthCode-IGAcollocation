...
parameters = setparameters_neurite_NN1();
...
center = [Nx/3,Ny/3;Nx/3,2*Ny/3;2*Nx/3,Ny/3;2*Nx/3,2*Ny/3];
...
save('theta_original_NN1.mat','theta_original');

% theta1 = load('theta_original_NN1.mat');
% theta = theta1.theta_original;

figure
imagesc(phi+flag_center)

MultipleResolution2D_neurite_NN1
