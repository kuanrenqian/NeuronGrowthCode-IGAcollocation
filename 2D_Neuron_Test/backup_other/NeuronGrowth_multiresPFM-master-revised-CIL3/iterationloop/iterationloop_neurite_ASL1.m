...
%         end
    ...
    %save variables
    if(mod(istep,100)==0)
        s1 = sprintf('postprocessing/phi_ASL1_%d.mat',iteration);
        s2 = sprintf('postprocessing/conc_ASL1_%d.mat',iteration);
        s3 = sprintf('postprocessing/conc_ASL1_tubulin_%d.mat',iteration);
        save(s1,'phi');
        save(s2,'conc');
        save(s3,'conc_t');
    end
    save('postprocessing/iteration_ASL1.mat','n_vector','iter_vector');
