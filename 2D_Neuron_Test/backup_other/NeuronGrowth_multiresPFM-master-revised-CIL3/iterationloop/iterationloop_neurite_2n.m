...
%         end
    ...
    %save variables
    if(mod(istep,100)==0)
        s1 = sprintf('postprocessing/phi2n_%d.mat',iteration);
        s2 = sprintf('postprocessing/conc2n_%d.mat',iteration);
        s3 = sprintf('postprocessing/conc2n_tubulin_%d.mat',iteration);
        save(s1,'phi');
        save(s2,'conc');
        save(s3,'conc_t');
    end
    save('postprocessing/iteration2n.mat','n_vector','iter_vector');
