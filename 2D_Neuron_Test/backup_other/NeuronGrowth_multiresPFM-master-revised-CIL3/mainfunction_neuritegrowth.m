...
addpath(strcat(path,'\thetas'));

parameters = setparameters_neurite();
...
[phi,conc,conc_t,theta,tempr] =nucleus_tubulin(Nx,Ny,seed,epsilonb);
phi_original = phi;
phi3 = zeros(Nx,Ny);

%theta_original = theta;
%save('theta_original_nc_3.mat','theta_original');

% theta1 = load('theta_original_nc.mat');
